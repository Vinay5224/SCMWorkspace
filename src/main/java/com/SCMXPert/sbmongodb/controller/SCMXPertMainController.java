...
public class SCMXPertMainController {
	...
	public String ShipmentDetails() {
		 ...
		 * }
		 html1 += "<ul>";
		html1 +=  "<a href='/Particularcustomer/0001'> Customer_Id : 0001 </a><br>";
		 html1 +=  "<a href='/Particularcustomer/0002'> Customer_Id : 0002</a><br>";
		 html1 +=  "<a href='/Particularcustomer/0003'> Customer_Id: 0003</a><br>";
		 html1 +=  "<a href='/Particularcustomer/0004'> Customer_Id : 0004</a><br>";
		 html1 +=  "<a href='/Allcustomerdetails'> Show all Customer details </a><br>";
		 html1 += "</ul>";
		 return html1;
	}
	...
	List<BusinessPartner> BusinessPartner = this.BusinessPartnerRepository.findAll();
	String html1="";
	ObjectMapper objectMapper = new ObjectMapper();
	String json1 = "";
	for (BusinessPartner Shp : BusinessPartner) {
	// for(i=0;i<)
	...
	public String Allcustomerdetails() {
		...
		ObjectMapper objectMapper = new ObjectMapper();
		String json1 = "";
		for (Shipments Shp : ShipmentDetails) {
		//	for(i=0;i<)
	...
	public String Customer() {
		...
		ObjectMapper objectMapper = new ObjectMapper();
		String json1 = "";
		for (Customer Cus : CustomerDetails) {
		//	for(i=0;i<)
			
		     try {
				json1 += objectMapper.writeValueAsString(Cus);
		 ...
		 * String html = ""; for (Customer emp1 : employees1) { html += emp1 + "<br>"; }
		 * 
		 * return html;
	...
	@ResponseBody
	@RequestMapping("/Particularcustomer/0001")
	public String Particularcustomer() {

		List<Shipments> employees = this.ShipmentsRepository.findBycustomerIdLike("0001");
		
		String html = "";
		for (Shipments emp : employees) {
			html += emp + "<br>";
		}
	...
	@ResponseBody
	@RequestMapping("/Particularcustomer/0002")
	public String Particularcustomer1() {

		List<Shipments> employees = this.ShipmentsRepository.findBycustomerIdLike("0002");
	...
	@ResponseBody
	@RequestMapping("/Particularcustomer/0003")
	public String Particularcustomer2() {

		List<Shipments> employees = this.ShipmentsRepository.findBycustomerIdLike("0003");
	...
	@ResponseBody
	@RequestMapping("/Particularcustomer/0004")
	public String Particularcustomer3() {

		List<Shipments> employees = this.ShipmentsRepository.findBycustomerIdLike("0004");
	...
	@ResponseBody
	@RequestMapping("/DeviceDataStream")
	public String DeviceDataStream() {

		List<DeviceDataStream> DeviceDataStreamDetails = this.DeviceDataStreamRepository.findAll();
		String html1="";
		ObjectMapper objectMapper = new ObjectMapper();
		String json1 = "";
		for (DeviceDataStream Shp : DeviceDataStreamDetails) {
		//	for(i=0;i<)
	...
	public String Devices() {
		...
		List<Devices> Devices = this.Devices.findAll();
		String html1="";
		ObjectMapper objectMapper = new ObjectMapper();
		String json1 = "";
		for (Devices Shp : Devices) {
		//	for(i=0;i<)
	...
	@ResponseBody
	@RequestMapping("/ShipmentTransactions")
	public String ShipmentTransactions() {

		List<ShipmentTransactions> ShipmentTransactions1 = this.ShipmentTransactions.findAll();
		String html1="";
		ObjectMapper objectMapper = new ObjectMapper();
		String json1 = "";
		for (ShipmentTransactions Shp : ShipmentTransactions1) {
		//	for(i=0;i<)
	...
	public String deleteAllEmployee() {
		...
		this.ShipmentsRepository.deleteAll();
		return "Deleted!";
	}*/
